...
3. Optionally click **Assignment brief** to set the intended scope — paste the scenario text, or **upload it as a file** (text, PDF, or an image such as a scanned brief). The tutor grounds its questioning in the brief while still making the "student" do the analysis.
